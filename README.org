...
Finally, if you haven't already done so, you can link your new ~./init.el~ file and necessary ~elisp/~ directory into your ~$HOME/.emacs.d/~ directory:

#+BEGIN_SRC bash :tangle no
  cd ~/.emacs.d
  rm init.el
  ln -s ~/PATH/TO/literatemacs/init.el .
  ln -s ~/PATH/TO/literatemacs/elisp .
#+END_SRC
